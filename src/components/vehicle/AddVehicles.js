...
const AddVehicles = () => {
  ...
  const {
    model, price_per_day, pict, picture, description, color,
  } = vehicle;
  ...
  const handleSubmit = (e) => {
    ...
    data.append('name', selectedOption);
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
              <div className="w-full sm:w-1/3 px-4 mb-4 sm:mb-0">
                <span className="text-sm font-medium text-gray-900">Select Jeep name</span>
              </div>
            ...
            <div className="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
              <div className="w-full sm:w-1/3 px-4 mb-4 sm:mb-0">
                <span className="text-sm font-medium text-gray-900">Picture url</span>
              </div>
              <div className="w-full sm:w-2/3 px-4">
                <div className="max-w-xl">
                  <div className="flex flex-wrap items-center -mx-3">
            ...
            <div className="flex hidden flex-wrap items-start -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
              ...
              <div className="w-full sm:w-2/3 px-4">
                <div className="flex flex-wrap sm:flex-nowrap max-w-xl">
                  ...
                  <div className="w-full py-8 px-4 text-center border-dashed border border-gray-400 hover:border-gray-300 focus:border-green-500 rounded-lg">
