    ...
    <div className="p-8 rounded-xl">
      ...
      <form action="">
            ...
            <div className="max-w-xl">
              <div className="flex flex-wrap items-center -mx-3">
                <div className="w-full sm:w-1-full px-3 mb-3 sm:mb-0">
                  <input className="block py-4 px-3 w-full text-sm text-gray-900 placeholder-gray-300 font-medium outline-none bg-transparent border border-gray-400 hover:border-white focus:border-green-500 rounded-lg" id="formInput1-1" type="text" value="Jeep" disabled />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
          ...
          <div className="w-full sm:w-2/3 px-4">
            <div className="max-w-xl">
              <input id="colorInput" onChange={handlechange} className="block py-1 px-3 w-44 h-12 outline-none bg-transparent border border-gray-400 hover:border-white focus:border-green-500 rounded-lg" value="#ff0000" type="color" placeholder="Select car color" />            </div>
            </div>
        </div>
        <div className="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
          <div className="w-full sm:w-1/3 px-4 mb-4 sm:mb-0">
            <span className="text-sm font-medium text-gray-900">For reservation</span>
          </div>
          <div className="w-full sm:w-2/3 px-4">
            <div className="max-w-xl">
              <div className="flex flex-wrap items-center -mx-3">
