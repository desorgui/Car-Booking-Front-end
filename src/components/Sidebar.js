...
import {
  faCar, faListCheck, faTrashAlt, faCheck, faPlus,
...
const Sidebar = () => {
  ...
  return (
    <div className="h-full lg:w-60">
      <nav className="lg:left-10 absolute left-0 z-50 flex items-center justify-between p-4 mb-3">
        <div className="w-full h-full xl:w-auto px-2 xl:mr-12">
          <div className="flex items-center justify-between">
            <div className="xl:hidden">
              <button type="button" onClick={toggleSidebar} className="navbar-burger text-gray-900 hover:text-gray-300 focus:outline-none">
      ...
      <div className="lg:block navbar-menu relative z-40 h-full">
        <div className="hidden navbar-backdrop top-0 left-0 w-full h-full bg-gray-800 opacity-50" />
        <nav id="sidebar" className="absolute lg:relative top-0 -translate-x-[100%] lg:translate-x-[0%] bottom-0 lg:w-full max-w-xxs flex flex-col h-full py-8 px-4 bg-white overflow-auto">
          <div className="mb-6">
          ...
          <div className="mt-8">
            <div className="flex items-center pl-4 text-gray-900 hover:bg-gray-300 cursor-pointer">
              ...
              <button type="button" onClick={logout} className="p-4 pr-16 text-sm font-semibold">Log Out</button>
            </div>
          </div>
        </nav>
      </div>
