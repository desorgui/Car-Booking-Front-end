      ...
      <form action="">
        <div class="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
          <div class="w-full sm:w-1/3 px-4 mb-4 sm:mb-0">
            <span class="text-sm font-medium text-gray-900">Car Name</span>
          </div>
          <div class="w-full sm:w-2/3 px-4">
            <div class="max-w-xl">
              <div class="flex flex-wrap items-center -mx-3">
                <div class="w-full sm:w-1-full px-3 mb-3 sm:mb-0">
                  <input class="block py-4 px-3 w-full text-sm text-gray-900 placeholder-gray-300 font-medium outline-none bg-transparent border border-gray-400 hover:border-white focus:border-green-500 rounded-lg" id="formInput1-1" type="text" value="Jeep" disabled />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="w-full sm:w-2/3 px-4">
            <div class="max-w-xl">
              <div class="relative block px-3 w-full text-sm font-medium border border-gray-400 hover:border-white focus-within:border-green-500 rounded-lg">
                ...
                <select class="w-full py-4 text-gray-900 placeholder-gray-300 appearance-none bg-transparent outline-none" id="formInput1-7" name="">
                  <option class="bg-gray-500" value="Wrangler">Wrangler</option>
                  <option class="bg-gray-500" value="4 X 4">4 X 4</option>
                  <option class="bg-gray-500" value="Wrangler">Wrangler</option>
                </select>
              </div>
            </div>
        ...
        <div class="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
          ...
          <div class="w-full sm:w-2/3 px-4">
            <div class="max-w-xl">
              <input id="colorInput" onChange={handlechange} class="block py-1 px-3 w-44 h-12 outline-none bg-transparent border border-gray-400 hover:border-white focus:border-green-500 rounded-lg" value="#ff0000" type="color" placeholder="Select car color" />            </div>
            </div>
        </div>
        <div class="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
          <div class="w-full sm:w-1/3 px-4 mb-4 sm:mb-0">
            <span class="text-sm font-medium text-gray-900">For reservation</span>
          </div>
          <div class="w-full sm:w-2/3 px-4">
            <div class="max-w-xl">
              <div class="flex flex-wrap items-center -mx-3">
                <div class="w-full sm:w-1-full px-3 mb-3 sm:mb-0">
                  <input class="block py-4 px-3 w-full text-sm text-gray-900 placeholder-gray-300 font-medium outline-none bg-transparent border border-gray-400 hover:border-white focus:border-green-500 rounded-lg" id="formInput1-1" type="date" placeholder="YYYY/MM/DD" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="flex flex-wrap items-start -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
          <div class="w-full sm:w-1/3 px-4 mb-5 sm:mb-0">
            <span class="block mt-2 text-sm font-medium text-gray-900">Description</span>
            <span class="text-xs text-gray-400">Lorem ipsum dolor sit amet</span>
          </div>
          <div class="w-full sm:w-2/3 px-4">
            <div class="max-w-xl"><textarea class="block h-48 py-4 px-3 w-full text-sm text-gray-900 placeholder-gray-300 font-medium outline-none bg-transparent border border-gray-400 hover:border-white focus:border-green-500 rounded-lg resize-none" id="formInput1-9" type="text" placeholder="Lorem ipsum dolor sit amet"></textarea></div>
          </div>
        </div>
      </form>
    </div>
