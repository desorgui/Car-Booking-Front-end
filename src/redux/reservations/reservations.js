...
export const deleteVehicleReservations = (vehicle_id) => ({ type: DELETE_VEHICLE_RESERVATION, payload: vehicle_id });
...
const reservationSlice = createSlice({
  ...
  extraReducers: {
    ...
    [deleteReservation.fulfilled]: (state, action) => (state.filter((elem) => elem.id !== action.payload)),
    [DELETE_VEHICLE_RESERVATION]: (state, action) => (state.filter((elem) => elem.vehicle_id !== action.payload)),
  },
});
